# -*- coding: utf-8 -*-
"""
Created on Wed Aug 26 12:04:12 2026
...
def calculer_remise(total_panier, code_promo):
    ...
    # Étape d'inspection : Observez la modification de cette variable
    taux_remise = 0.0
    ...
    # BUG VOLONTAIRE : Erreur de calcul (devrait être total * taux_remise)
...
def traiter_panier(utilisateur, articles):
    ...
    for article, prix in articles.items():
        total += prix
        # Utile pour tester le "Resume Program" ou les points d'arrêt conditionnels
        time.sleep(0.1)
